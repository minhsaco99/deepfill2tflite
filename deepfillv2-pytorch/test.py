...
parser.add_argument("--image", type=str,
                    default="examples/inpaint/case2.png", help="path to the image file")
parser.add_argument("--mask", type=str,
                    default="examples/inpaint/case2_mask.png", help="path to the mask file")
parser.add_argument("--out", type=str,
                    default="examples/inpaint/case2_out_test.png", help="path for the output file")
